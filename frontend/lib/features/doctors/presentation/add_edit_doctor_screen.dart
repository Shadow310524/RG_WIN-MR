...
class _AddEditDoctorScreenState extends ConsumerState<AddEditDoctorScreen> {
  ...
  Future<void> _submitForm() async {
    ...
    if (result != null) {
      ...
      if (context.canPop()) {
        ...
        context.go(
          widget.isEditing ? '/doctors/${widget.doctorId}' : '/doctors',
        );
      }
    }
  }
  ...
  bool get _hasUnsavedChanges {
    final dirtyName = _nameController.text.trim().isNotEmpty;
    final dirtyPhone = _phoneController.text.trim().isNotEmpty;
    final dirtyLicense = _licenseController.text.trim().isNotEmpty;
    final dirtySpecialization = _specializationController.text
        .trim()
        .isNotEmpty;
    final dirtyClinic = _clinicController.text.trim().isNotEmpty;
    final dirtyAddress = _addressController.text.trim().isNotEmpty;
  ...
  Future<void> _handleBack() async {
    ...
    if (context.canPop()) {
      ...
      context.go(widget.isEditing ? '/doctors/${widget.doctorId}' : '/doctors');
    }
  }
